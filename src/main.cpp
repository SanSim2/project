...
int main() {
    ...
    vector<std::string> faces
            {
                    FileSystem::getPath("resources/textures/Lycksele/posx.jpg"),
                    FileSystem::getPath("resources/textures/Lycksele/negx.jpg"),
                    FileSystem::getPath("resources/textures/Lycksele/posy.jpg"),
                    FileSystem::getPath("resources/textures/Lycksele/negy.jpg"),
                    FileSystem::getPath("resources/textures/Lycksele/negz.jpg"),
                    FileSystem::getPath("resources/textures/Lycksele/posz.jpg")
            };
    /*vector<std::string> faces
            {
    ...
    // load models
    // -----------
    Model ourModel("resources/objects/air_ballon/Air_Balloon.obj");
